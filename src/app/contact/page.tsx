    ...
    return (
        <div className="relative isolate bg-white">
            ...
            <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
                    <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            Get involved with the INSEAD Finance Group. We are always looking for new members and
                            volunteers to help us with our mission. If you have any questions, please feel free to reach out!
                        </p>
                ...
                <form action="#" method="POST" className="px-6 pb-12 pt-20 lg:px-8 lg:pt-48">
